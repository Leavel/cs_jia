...
def init_add_account():
    ...
    BOT_ACCOUNTS = [
        ...
        Account(
            ...
            account_api_hash='47e4ae290a26be30a688100e9e78093b',  # Insert your own Telegram API Hash here
            ...
            account_phone='+8618423502420',  # Enter your burner phone number here
...
def init_add_channels():
    ...
    CHANNELS = [
        {
            'channel_name': '机器人测试',
            'channel_id': 100143357906,  # Enter your own Telegram channel ID for monitoring here
            'channel_url': 'https://t.me/leve666',
...
def initialize_db():
    ...
    if os.getenv('GAE_INSTANCE'):
        ...
        MYSQL_CONNECTOR_STRING = 'mysql+pymysql://root:123456@192.168.2.177:3306/{}'.format(DATABASE_NAME)
    else:
        SERVER_MODE = 'local'
        MYSQL_CONNECTOR_STRING = 'mysql+pymysql://root:123456@127.0.0.1:3306/{}'.format(DATABASE_NAME)

    engine = db.create_engine(MYSQL_CONNECTOR_STRING, echo=True)#),pool_size=50,max_overflow=100
